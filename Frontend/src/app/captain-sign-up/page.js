      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <form className="w-full max-w-md flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <span className="text-xs font-medium text-gray-500 uppercase tracking-widest">Vehicle Info</span>
            <div className="flex-1 h-px bg-white/[0.06]" />
          </div>
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/captain-sign-in" className="text-[#E30613] hover:underline cursor-pointer font-medium">
              Sign In
            </Link>
          </p>
        </form>
